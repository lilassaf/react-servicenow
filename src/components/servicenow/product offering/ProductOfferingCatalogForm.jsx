// src/features/productOfferingCatalog/AddCatalogForm.jsx
...
//   onSubmit: (catalogData: object) => Promise<void>; // Expects a promise for async handling
//   onCancel: () => void;
//   isLoading: boolean;
// }

function ProductOfferingCatalogForm({ onSubmit, onCancel, isLoading, initialData = null }) {
  ...
  return (
    <form onSubmit={handleSubmit}>
            ...
            <div style={{marginTop: '20px', textAlign: 'right'}}>
                ...
                <button type="submit" style={submitButtonStyle} disabled={isLoading}>{isLoading ? 'Saving...' : (isEditMode ? 'Update Catalog' : 'Create Catalog')}</button>
            </div>
        </form>
  );
}
